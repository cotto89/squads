...
exports.dispatch = exports.ActionEmitter = undefined;
...
var ActionEmitter = exports.ActionEmitter = function () {
    ...
    (0, _createClass3.default)(ActionEmitter, [{
        ...
        value: function onDispatch(context, handler) {
            if (process.env.NODE_ENV !== 'production') {
                (0, _asserts.hasRegisteredHandler)(context, this.handlers[context]);
            }
        ...
        value: function dispatch(payloads, value) {
            ...
            try {
                for (var _iterator2 = (0, _getIterator3.default)($payloads), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (process.env.NODE_ENV !== 'production') {
                        (0, _asserts.hasHandler)(event, handler);
                    }
        ...
        value: function register(context, handler) {
            if (process.env.NODE_ENV !== 'production') {
                (0, _asserts.hasRegisteredHandler)(context, this.shareds[context]);
            }
